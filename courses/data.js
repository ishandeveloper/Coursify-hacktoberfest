let data = [
	...
	{
		name: 'Docker and Kubernetes Tutorial | Full Course [2020]',
		instructor: 'Amigoscode',
		url: 'https://www.youtube.com/watch?v=bhBSlnQcq2k',
		description:
			'A complete Docker and Kubernetes Tutorial that is around 4 and half hours long by Amigoscode. The update is recent and of high quality.Starting with docker for beginners to all you need to know about creating docker images, running docker containers, docker volumes, container registry and docker architecture.',
		image: 'docker-kuber.jpg',
